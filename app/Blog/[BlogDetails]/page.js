  ...
  return (
    ...
    <div className='w-full max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-[7fr_3fr] gap-x-10 mt-8 px-6'>
        ...
        <article className='space-y-4 mt-8'>
            <h3 className='font-semibold text-4xl'>Tailored to Your Audience</h3>
        ...
        <div className='border-l-4 border-purple-600 px-6 mt-8 bg-gray-50 py-2'>
        ...
        <article className='text-gray-500 space-y-8 mt-12'>
