  ...
  return (
    ...
    <section className='min-h-screen flex items-center justify-center'>
        <form className=' w-full max-w-110 flex flex-col items-center p-10 rounded-3xl shadow-2xl shadow-gray-700 gap-y-6'>
           ...
           <div className='w-full flex items-center justify-between flex-wrap gap-x-6 gap-y-4 text-lg'>
             <div className='flex items-center justify-start gap-x-2'>
                <input type='checkbox' id='terms_conditions' required/> 
                <label htmlFor='terms_conditions'>Remember me</label>
            </div>
            <Link href={'/'} 
            className='text-green-500'>Forgot Password</Link>
           </div>
            <div className='w-full'>
                <button className='w-full font-semibold text-white bg-purple-500 py-2 rounded-full' type='submit'>Login Now</button>
            </div>
            ...
            <p>Already have an account? <Link className='text-green-500' href={'/Login'}>Register here</Link> </p>
        </form>
    </section>
    </>
  )
